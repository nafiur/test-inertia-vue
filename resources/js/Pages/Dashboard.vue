                ...
                <div class="card bg-white border-0 rounded-3 mb-4">
                    <div class="card-body p-4">
                        ...
                        <ul class="ps-0 mb-0 list-unstyled sales_by_locations mt-4">
                            ...
                            <li class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="assets/images/united-kingdom.svg" class="wh-30 rounded-circle"
                                        alt="united-kingdom" />
                                </div>
                                <div class="flex-grow-1 ms-3">
                                ...
                                <table class="table align-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="product-details.html" class="d-flex align-items-center">
                                                    <img src="assets/images/product-1.jpg" class="wh-40 rounded-3"
                                                        alt="product-1" />
                                                    <div class="ms-2 ps-1">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="product-details.html" class="d-flex align-items-center">
                                                    <img src="assets/images/product-2.jpg" class="wh-40 rounded-3"
                                                        alt="product-2" />
                                                    <div class="ms-2 ps-1">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="product-details.html" class="d-flex align-items-center">
                                                    <img src="assets/images/product-3.jpg" class="wh-40 rounded-3"
                                                        alt="product-3" />
                                                    <div class="ms-2 ps-1">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="product-details.html" class="d-flex align-items-center">
                                                    <img src="assets/images/product-4.jpg" class="wh-40 rounded-3"
                                                        alt="product-4" />
                                                    <div class="ms-2 ps-1">
                                                        <h6 class="fw-medium fs-14">
                                                            Bluetooth Speaker
                                        ...
                                        <tr>
                                            <td>
                                                <a href="product-details.html" class="d-flex align-items-center">
                                                    <img src="assets/images/product-5.jpg" class="wh-40 rounded-3"
                                                        alt="product-5" />
                                                    <div class="ms-2 ps-1">
                                                        <h6 class="fw-medium fs-14">
                                                            Airbuds 2nd Gen
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3 mb-lg-4">
                            ...
                            <div class="d-flex">
                                ...
                                <select class="form-select month-select form-control"
                                ...
                                <table class="table align-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="my-profile.html" class="d-flex align-items-center">
                                                    <img src="assets/images/user-1.jpg" class="wh-40 rounded-3"
                                                        alt="user" />
                                                    <div class="ms-2 ps-1">
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-success bg-opacity-10 text-success p-2 fs-12 fw-normal">Shipped</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>#JAN-1323</td>
                                            <td>
                                                <a href="my-profile.html" class="d-flex align-items-center">
                                                    <img src="assets/images/user-2.jpg" class="wh-40 rounded-3"
                                                        alt="user" />
                                                    <div class="ms-2 ps-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="my-profile.html" class="d-flex align-items-center">
                                                    <img src="assets/images/user-3.jpg" class="wh-40 rounded-3"
                                                        alt="user" />
                                                    <div class="ms-2 ps-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="my-profile.html" class="d-flex align-items-center">
                                                    <img src="assets/images/user-4.jpg" class="wh-40 rounded-3"
                                                        alt="user" />
                                                    <div class="ms-2 ps-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="my-profile.html" class="d-flex align-items-center">
                                                    <img src="assets/images/user-5.jpg" class="wh-40 rounded-3"
                                                        alt="user" />
                                                    <div class="ms-2 ps-1">
                    ...
                    <div class="card-body p-4">
                        ...
                        <ul class="ps-0 mb-0 list-unstyled sales_by_locations style-two">
                            <li>
                                ...
                                <div class="progress" role="progressbar" aria-label="Success example" aria-valuenow="60"
                            ...
                            <li>
                                ...
                                <div class="progress" role="progressbar" aria-label="Primary example" aria-valuenow="30"
                                    aria-valuemin="0" aria-valuemax="100">
                        ...
                        <ul class="ps-0 mb-0 list-unstyled">
                            ...
                            <li class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <i
                                            class="material-symbols-outlined icon-circle bg-primary bg-opacity-10 text-primary text-center rounded-circle wh-40 lh-40">credit_score</i>
                                    </div>
                                    <div class="flex-grow-1 ms-2">
